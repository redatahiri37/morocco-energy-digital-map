...
| 2026-08-12 | 07:57 | OBJ-map-debugger-1 | `4cac17b` | a regulator or DC developer who spots a wrong coordinate or stale figure can actually get the correction delivered, instead of every "Report an error" click going to a non-deliverable `example.com` placeholder |
