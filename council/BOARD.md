...
_none_ — OBJ-map-debugger-1 was ruled SHIP 2026-08-13 18:05, executed, gated
(security-engineer PASS, map-tester GO), committed as `9de5a15`, and moved
to Shipped below within the same sitting.
...
| 2026-08-13 | 18:05 | OBJ-map-debugger-1 | `9de5a15` | a regulator or DC developer who spots a wrong coordinate can actually get the correction to land, instead of every "Report an error" link going to a non-deliverable placeholder address |
