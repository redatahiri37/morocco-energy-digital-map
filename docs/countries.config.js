  ...
  morocco: {
    ...
    layers: [
      ...
      { id: "grid-lines", file: "grid-lines.geojson", kind: "lines",
        title: "Interconnectors, HVDC & planned corridors",
        source: "Editorial overlay on OpenInfraMap (OSM, ODbL) · interconnectors from REE/Xlinks/ONEE · planned lines from WBG 2018",
